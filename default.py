...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._tx_gain_range = qtgui.Range(0, 1, 0.02, 0.8, 200)
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
            1024, #size
            samp_rate, #samp_rate
            "Original Signal (Time domain)", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_win, 6, 0, 2, 2)
        for r in range(6, 8):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_0_1_win, 4, 0, 2, 2)
        for r in range(4, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.blocks_stream_to_tagged_stream_0_0 = blocks.stream_to_tagged_stream(gr.sizeof_int, 1, preamble_len, "packet_len")
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_int, 1, packet_len, "packet_len")
    ...
    def set_preamble_len(self, preamble_len):
        ...
        self.blocks_stream_to_tagged_stream_0_0.set_packet_len(self.preamble_len)
        self.blocks_stream_to_tagged_stream_0_0.set_packet_len_pmt(self.preamble_len)
